...
def function_with_statement_return_based_on_inside_var_with_several_vars_and_name_alias():
	...
	second_dir = {'int': 23}
	alias_var = dict_var
	return alias_var['num'] * alias_var['value_two'] * second_dir['int']
...
def function_with_str_and_atr_error():
	...
	second_dir = {'int': 23}
	alias_var = dict_var
	return alias_var['num'] * alias_var['not_exist'] + second_dir['int']
...
def function_with_return_alias():
	...
	second_dir = {'str': '_123'}
	alias_var = dict_var
	return alias_var['num'] * alias_var['value_two'] + second_dir['str']
